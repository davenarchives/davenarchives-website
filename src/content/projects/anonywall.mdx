...
- [Deployment & Build Notes](#deployment--build-notes)
...
- Semantic headings and accessible labels on forms and buttons.
- Alt text on cover and avatar imagery.
- Lightweight bundle via Vite; Firestore reads batched through controllers; avoid unnecessary re-renders by relying on context selectors where applicable.
